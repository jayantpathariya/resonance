...
function NavSection({ label, items, pathname }: NavSectionProps) {
  return (
    <SidebarGroup>
      {label && (
        <SidebarGroupLabel className="text-[13px] text-muted-foreground">
          {label}
        </SidebarGroupLabel>
      )}
      <SidebarGroupContent>
...
export const DashboardSidebar = () => {
  ...
  const otherMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:support@voiceflow.com",
      icon: HeadphonesIcon,
    },
  ];
              ...
              appearance={{
                elements: {
                  ...
                  organizationSwitcherTrigger:
                    "w-full! justify-between! bg-white! border! border-border! rounded-md! pl-1! pr-2! py-1! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:p-1! shadow-[0px_1px_1.5px_0px_rgba(44,54,53,0.03)]",
